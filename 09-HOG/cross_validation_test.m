...
num_negative_examples = 200; %Higher will work strictly better, but you should start with 10000 for debugging
...
csvwrite('precision_test.csv', precision);
csvwrite('recall_test.csv', recall);